describe("Teste a pagina de Dashboard", () => {
  ...
  it("Quando clicar em um pokemon deve abrir a pagina de detalhes", () => {
    cy.visit("/dashboard");
  ...
  it("Quando clicar em um pokemon deve abrir a pagina de detalhes e depois voltar para a listagem de 3 pokemons", () => {
    cy.visit("/dashboard");
  ...
  it("Verificar um o formulario se tem have css e grid", () => {
    cy.visit("/dashboard");
